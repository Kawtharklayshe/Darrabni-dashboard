...
const resolveUserRoleVariant = role => {
  ...
  if (roleLowerCase === 'science')
    return {
      color: 'info',
      icon: 'tabler-edit',
    }
  if (roleLowerCase === 'front')
    return {
      color: 'secondary',
...
const deleteUser = id => {
  traineeListStore.deleteUser(id)
